...
printf "                                                                                                \e[1;92m.-\"\"\"\"-. \e[0m\n"
printf "                  _________             .__       .__  ___________.__            .___                     \e[1;92m/        \ \e[0m\n"
printf "\e[1;77m          /   _____/ ____   ____ |__|____  |  | \_   _____/|__| ____    __| _/___________   \e[0m\e[1;92m/_        _\ \e[0m\n"
printf "\e[1;77m          \_____  \ /  _ \_/ ___\|  \__  \ |  |  |    __)  |  |/    \  / __ |/ __ \_  __ \ \e[0m\e[1;92m// \      / \\ \e[0m\n"
printf "\e[1;77m          /        (  <_> )  \___|  |/ __ \|  |__|     \   |  |   |  \/ /_/ \  ___/|  | \/ \e[0m\e[1;92m|\__\    /__/| \e[0m\n"
printf "\e[1;77m          /_______  /\____/ \___  >__(____  /____/\___  /   |__|___|  /\____ |\___  >__|    \e[0m\e[1;92m\    ||    / \e[0m\n"
printf "\e[1;77m                \/            \/        \/          \/            \/      \/    \/           \e[0m\e[1;92m\        / \e[0m\n"
printf "                                                     \e[1;92mv1.0, Author: @SecurityHackerChanel\e[0m   \e[1;92m\  __  / \e[0m\n"
printf "                                                      \e[1;92m'.__.' \e[0m\n"



printf "                                                          \e[1;92m \e[0m\n"
printf "\e[1;77m _________             .__       .__               \e[1;92m \e[0m\n"
printf "\e[1;77m/   _____/ ____   ____ |__|____  |  |             \e[1;92m \e[0m\n"
printf "\e[1;77m\_____  \ /  _ \_/ ___\|  \__  \ |  |             \e[1;92m \e[0m\n"
printf "\e[1;77m/        (  <_> )  \___|  |/ __ \|  |__           \e[1;92m \e[0m\n"
printf "\e[1;77m/_______  /\____/ \___  >__(____  /____/          \e[1;92m \e[0m\n"
printf "\e[1;77m___________.__        \/  .___  \/                \e[1;92m \e[0m\n"
printf "\e[1;77m\_   _____/|__| ____    __| _/___________         \e[1;92m \e[0m\n"
printf "\e[1;77m |    __)  |  |/    \  / __ |/ __ \_  __ \        \e[1;92m \e[0m\n"
printf "\e[1;77m |     \   |  |   |  \/ /_/ \  ___/|  | \/        \e[1;92m \e[0m\n"
printf "\e[1;77m \___  /   |__|___|  /\____ |\___  >__|           \e[1;92m \e[0m\n"
printf "\e[1;77m    \/            \/      \/    \/                \e[1;92m \e[0m\n"
printf "\e[1;92mv1.0, Author: @SecurityHackerChanel\e[1;92m \e[0m\n"
...
check=$(curl -s "https://codepen.io/$username" -L -H "Accept-Language: en" -i | grep -o 'Page Not Found' ; echo $?)
...
printf "\e[1;77m[\e[0m\e[1;92m+\e[0m\e[1;77m] linux.org.ru: \e[0m"
check=$(curl -s "https://linux.org.ru/$username/profile" -L -H "Accept-Language: en" -i | grep -o 'The URL you requested was not found on this' ; echo $?)

if [[ $check == *'1'* ]]; then
printf "\e[1;92m Found!\e[0m https://linux.org.ru/%s/profile\n" $username
printf "https://linux.org.ru/+%s/profile\n" $username >> $username
elif [[ $check == *'0'* ]]; then
printf "\e[1;93mNot Found!\e[0m\n"
fi
...
printf "\e[1;77m[\e[0m\e[1;92m+\e[0m\e[1;77m] moikrug.ru: \e[0m"
check1=$(curl -s -i "https://moikrug.ru/$username" -L -H "Accept-Language: en" -i | head -n1 | grep -o '404' ; echo $?)

if [[ $check1 == *'0'* ]] ; then
printf "\e[1;93mNot Found!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then

printf "\e[1;92m Found!\e[0m moikrug.ru/%s\n" $username
...
check1=$(curl -s -i "https://$username.wordpress.com" -L -H "Accept-Language: en" -i | grep -o 'Site names can only contain lowercase letters' ; echo $?)
...
## Freelancehunt заказчики

printf "\e[1;77m[\e[0m\e[1;92m+\e[0m\e[1;77m] Freelancehunt заказчики: \e[0m"
check1=$(curl -s -i "https://freelancehunt.com/employer/$username.html" -H "Accept-Language: en" -L | grep -o 'HTTP/2 404' ; echo $?)

if [[ $check1 == *'0'* ]] ; then
printf "\e[1;93mNot Found!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then

printf "\e[1;92m Found!\e[0m https://freelancehunt.com/employer/%s.html\n" $username
printf "https://freelancehunt.com/employer/%s.html\n" $username >> $username.txt
fi

## Freelancehunt исполнители

printf "\e[1;77m[\e[0m\e[1;92m+\e[0m\e[1;77m] Freelancehunt исполнители: \e[0m"
check1=$(curl -s -i "https://freelancehunt.com/freelancer/$username.html" -H "Accept-Language: en" -L | grep -o 'HTTP/2 404' ; echo $?)

if [[ $check1 == *'0'* ]] ; then
printf "\e[1;93mNot Found!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then

printf "\e[1;92m Found!\e[0m https://freelancehunt.com/freelancer/%s.html\n" $username
printf "https://freelancehunt.com/freelancer/%s.html\n" $username >> $username.txt
fi
...
check1=$(curl -s -i "https://cash.me/$username" -H "Accept-Language: en" -L | grep -o 'Oh no'; echo $?)
...
check1=$(curl -s -i "https://www.instructables.com/member/$username" -H "Accept-Language: en" -L | grep -o '404' ; echo $?)
...
check1=$(curl -s -i "https://kongregate.com/accounts/$username" -H "Accept-Language: en" -L | grep -o 'no account with that name was found' ; echo $?)
...
check1=$(curl -s -i "https://foursquare.com/$username" -H "Accept-Language: en" -L | grep -o 'ind the page you' ; echo $?)
...
printf "\e[1;77m[\e[0m\e[1;92m+\e[0m\e[1;77m] Ask.me: \e[0m"
check1=$(curl -s -i "https://ask.me/$username" -H "Accept-Language: en" -L | grep -o 'Page not found' ; echo $?)

if [[ $check1 == *'0'* ]] ; then
printf "\e[1;93mNot Found!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then

printf "\e[1;92m Found!\e[0m https://ask.me/%s\n" $username
printf "https://ask.me/%s\n" $username >> $username.txt
fi
